  ...
  return (
    <NavContainer>
      ...
      <div className="flex items-center gap-6">
        ...
        {loggedIn ? (
          <a href="https://testblogdev.netlify.app/admin/"><button className="transition duration-200 rounded-3xl border border-black px-3 py-1 md:px-7 md:py-3 md: text-base text-black hover:text-white hover:bg-black">
          Post
        </button></a> 
        ) : (
          <button
            onClick={login}
            className="transition duration-200 rounded-3xl border border-black px-3 py-1 md:px-7 md:py-3 md: text-base text-black hover:text-white hover:bg-black"
          >
            Admin Login
          </button>
        )}
